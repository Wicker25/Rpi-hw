/* 
    Title --- display/pcd8544-skeleton.hpp
...
#ifndef _RPI_HW_DISPLAY_PCD8544_SKELETON_HPP_
#define _RPI_HW_DISPLAY_PCD8544_SKELETON_HPP_
...
/*!
	@class pcd8544_skeleton
	@brief Philips PCD8544 LCD controller (Skeleton).
*/
class pcd8544_skeleton : public designer< int8_t, bool, 1 > {
...
public:
	...
	/*!
		...
		@param[in] pins Sequence of `uint8_t` containing the control pins.
	*/
	pcd8544_skeleton( std::initializer_list< uint8_t > pins );

	//! Destructor method.
	virtual ~pcd8544_skeleton();
	...
	*/
	virtual void cmd( uint8_t data ) = 0;
...
#include <rpi-hw/display/pcd8544-skeleton-inl.hpp>

#endif /* _RPI_HW_DISPLAY_PCD8544_SKELETON_HPP_ */
